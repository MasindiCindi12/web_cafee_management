<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="remove_items.aspx.cs" Inherits="web_cafee_management.remove_items" %>
    ...
    <div class="row">  
        ...
        <div class="col-sm-8 sm-offset-0">
            ...
            <asp:Panel ID="Panel1" CssClass="form-control" Height="375px" runat="server">
                <asp:Label ID="Label1" runat="server" Text="Remove Items" Font-Names="Comic Sans MS" Font-Bold="True" Font-Size="16pt" ForeColor="#000076" />
                <br />
                <br />

                <div class="row">
         
                    <div class="col-sm-10 sm-offset-4">
                    ...
                    <br />
                        <div class="row">
                            <div class="col-sm-12 sm-offset-0">
                                <asp:GridView ID="GridView1" Width="100%" Height="35%" AllowPaging="true" AllowSorting="true" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateSelectButton="True" PageSize="7">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <asp:Button ID="btnDelete" CssClass="form-control btn btn-primary" runat="server" Text="Delete Item" OnClick="btnDelete_Click" />
                            </div>
                        </div>
